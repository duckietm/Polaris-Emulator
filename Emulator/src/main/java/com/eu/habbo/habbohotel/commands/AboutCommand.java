...
public class AboutCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) {
        ...
        message.append("<b>Credits</b>\r")
                ...
                .append("- Krews Team\r")
                .append("- DuckieTM, simoleo89, Medievalshell, Lorenzo (the wired master), Remco\r")
                .append("- Dippy (modern wired architecture)\r")
                .append("- Seth / iSetht (community wired and Nitro work)\r\n")
