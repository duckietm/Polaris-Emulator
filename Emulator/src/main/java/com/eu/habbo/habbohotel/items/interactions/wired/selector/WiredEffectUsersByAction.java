...
public class WiredEffectUsersByAction extends InteractionWiredEffect {
    ...
    private boolean matchesRecentAction(RoomUnit roomUnit) {
        ...
        if (!(actionValue instanceof Integer actionId) || !(timestampValue instanceof Long timestamp)) {
            return false;
        }
        ...
        int parameter = (parameterValue instanceof Integer paramInt) ? paramInt : -1;
