...
public class CatalogAdminSetPageVisibleEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        var page = mutations
                ...
                .orElseThrow(() -> new IllegalArgumentException("Page not found in shared draft: " + pageId));
        var result = mutations.apply(new CatalogDraftMutationRequest(
                ...
                new Gson().toJson(CatalogSnapshotPatch.setPageVisible(page, visible))));
        this.client.sendResponse(new CatalogAdminResultComposer(
                true, "Page visibility saved in shared draft at revision " + result.revision()));
    }
}
