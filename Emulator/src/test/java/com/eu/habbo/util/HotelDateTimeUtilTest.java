...
class HotelDateTimeUtilTest {
    ...
    @Test
    void strictTimestampParserRejectsLenientAndTrailingInput()
            throws Exception {
        Method parser = HotelDateTimeUtil.class.getDeclaredMethod(
        ...
        assertParseFailure(
                parser, "2024-02-29 01:02:03 trailing");
    }

    private static void assertParseFailure(
            Method parser, String value) {
