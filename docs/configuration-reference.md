...
| `persistence.executor.queue.capacity` | integer | `0` | `PERSISTENCE_EXECUTOR_QUEUE_CAPACITY` | yes | no | Dedicated persistence executor override; zero uses the selected operational profile. |
